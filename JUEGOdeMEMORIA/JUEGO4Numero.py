...
cuadros = [
    [Cuadro("assets/uno.png"), Cuadro("assets/uno.png"),
     Cuadro("assets/dos.png"), Cuadro("assets/dos.png")],
    [Cuadro("assets/tres.png"), Cuadro("assets/tres.png"),
     Cuadro("assets/cuatro.png"), Cuadro("assets/cuatro.png")],
    [Cuadro("assets/cinco.png"), Cuadro("assets/cinco.png"),
     Cuadro("assets/seis.png"), Cuadro("assets/seis.png")],
    [Cuadro("assets/siete.png"), Cuadro("assets/siete.png"),
     Cuadro("assets/ocho.png"), Cuadro("assets/ocho.png")],
    [Cuadro("assets/nueve.png"), Cuadro("assets/nueve.png"),
     Cuadro("assets/diez.png"), Cuadro("assets/diez.png")],
]
