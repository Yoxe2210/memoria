...
altura_boton = 30
medida_cuadro = 130
nombre_imagen_oculta = "assets/oculte.png"
...
#Crear tablero
cuadros = [
    [Cuadro("assets/B1.png"), Cuadro("assets/B1.png"),
     Cuadro("assets/B2.png"), Cuadro("assets/B2.png")],
    [Cuadro("assets/B3.png"), Cuadro("assets/B3.png"),
     Cuadro("assets/B4.png"), Cuadro("assets/B4.png")],
    [Cuadro("assets/B5.png"), Cuadro("assets/B5.png"),
     Cuadro("assets/B6.png"), Cuadro("assets/B6.png")],
    [Cuadro("assets/B7.png"), Cuadro("assets/B7.png"),
     Cuadro("assets/B8.png"), Cuadro("assets/B8.png")],
]
