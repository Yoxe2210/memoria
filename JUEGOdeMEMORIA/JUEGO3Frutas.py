...
altura_boton = 30
medida_cuadro = 130
nombre_imagen_oculta = "assets/imagenes/oculta.png"
...
cuadros = [
    [Cuadro("imagenes/cambur.png"), Cuadro("imagenes/cambur.png"),
     Cuadro("imagenes/limon.png"), Cuadro("imagenes/limon.png")],
    [Cuadro("imagenes/lechoza.png"), Cuadro("imagenes/lechoza.png"),
     Cuadro("imagenes/mango.png"), Cuadro("imagenes/mango.png")],
    [Cuadro("imagenes/mamones.png"), Cuadro("imagenes/mamones.png"),
     Cuadro("imagenes/mangoverde.png"), Cuadro("imagenes/mangoverde.png")],
    [Cuadro("imagenes/azucar.png"), Cuadro("imagenes/azucar.png"),
     Cuadro("imagenes/Piña.png"), Cuadro("imagenes/Piña.png")],
]
